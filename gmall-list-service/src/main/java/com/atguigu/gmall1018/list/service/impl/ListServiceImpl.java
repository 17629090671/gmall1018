package com.atguigu.gmall1018.list.service.impl;
...
public class ListServiceImpl implements ListService {
    ...
    public void incrHotScore(String skuId) {
        ...
        // jedis 如何记录用户访问的数据 1,2,3
        //  知道五种数据类型！
        Double hotScore = jedis.zincrby("hotScore", 1, "skuId:" + skuId);

        // 需要跟一个计数规则进行存值
        /*
            POST /gmall/SkuInfo/32/_update
            {
              "doc": {
                "hotScore" :"10"
              }
         ...
         */
        if (hotScore%10==0){
            // 更新es 中的hotScore   Math.round(11.5) 12  Math.round(-11.5) -11
